...
Formal statement of hype 3.1: If we send the same prompt with the same choices to the model and cut the thinking process where the interpretation of the word likely happnes (a.k.a resampling) The model picks up choice C more than E.

-- hyp 3.2: 
--- observation based on previous runs: Eval-awareness makes the reasoning more accurate and mathematical.
Formal statement of hype 3.1: eval-awareness moves the result toward E because it woud interprete the word "likely" more mathematical. 
